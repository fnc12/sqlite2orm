...
- [x] 25.3: Reflection-based `make_table` (sqlite_orm #1492) as a
  `table_mapping_style` decision point, offered only when
...
Phases 1–23, 25.1 and 25.3 above are **complete** (`[x]`). Further work is driven by
